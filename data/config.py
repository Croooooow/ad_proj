...
with open('./data/coco_stuff_full_class_name.pkl','rb') as f:
	COCO_STUFF_CLASSES = pickle.load(f)
with open('./data/coco_stuff_full_class_map.pkl','rb') as f:
	COCO_STUFF_LABEL_MAP = pickle.load(f)
...
cocostuff_dataset = dataset_base.copy({
	'name' : 'coco stuff',
	'train_images': './data/coco/train2017',
	'valid_images':'./data/coco/val2017',
	'train_info':'./data/coco/annotations/stuff_train2017.json',
	'valid_info' : './data/coco/annotations/stuff_val2017.json',
	'has_gt' : True,	
	'label_map': {171:1,172:2,173:3,174:4,175:5,176:6,177:7},
	'class_names':('wall-brick','wall-concrete','wall-other','wall-panel','wall-stone','wall-tile','wall-wood')
...
yolact_stuffwallonly_config=yolact_base_config.copy({
	'lr_steps': (280000, 600000, 700000, 750000),
	'max_iter': 800000,

	'name':'yolact_stuff',
	'dataset':cocostuff_dataset ,
	'num_classes': len(cocostuff_dataset.class_names)+1,
	'useful_labels':{171,172,173,174,175,176,177},		
	'use_semantic_segmentation_loss': True
})
...
yolact_stuff_res50_config=yolact_resnet50_config.copy({
	'lr_steps': (280000, 600000, 700000, 750000),
	'max_iter': 800000,

	'name':'yolact_stuff_res50',
	'dataset':cocostuff_dataset ,
	'num_classes': len(cocostuff_dataset.class_names)+1,
	'useful_labels':{171,172,173,174,175,176,177},		
	'use_semantic_segmentation_loss': True
